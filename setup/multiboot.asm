...
STATIC_MULTIBOOT_HEADER_VIDEO_MODE_WIDTH	equ	VARIABLE_VIDEO_WIDTH	; szerokość
STATIC_MULTIBOOT_HEADER_VIDEO_MODE_HEIGHT	equ	VARIABLE_VIDEO_HEIGHT	; wysokość
STATIC_MULTIBOOT_HEADER_VIDEO_MODE_DEPTH	equ	VARIABLE_VIDEO_DEPTH	; głębia kolorów
...
; wszystkie tablice nerwalgiczne trzymamy pod pełnym adresem 64 bitowym
align	STATIC_QWORD_SIZE

.table_multiboot_header:
	; tablica nagłówka multiboot w wersji 1.x
	dd	STATIC_MULTIBOOT_HEADER_MAGIC
	dd	STATIC_MULTIBOOT_HEADER_FLAG_MEMORY_MAP + STATIC_MULTIBOOT_HEADER_FLAG_VIDEO + STATIC_MULTIBOOT_HEADER_FLAG_NO_ELF
