...
%define	VARIABLE_KERNEL_VERSION			"0.616"
...
VARIABLE_NUMBER_SYSTEM_DECIMAL			equ	0x0A
VARIABLE_NUMBER_SYSTEM_HEXADECIMAL		equ	0x10
...
VARIABLE_KERNEL_SERVICE_NETWORK_SEND		equ	0x0404
...
VARIABLE_VIDEO_MODE_BASE_ADDRESS		equ	0x000A0000
VARIABLE_VIDEO_MODE_SIZE			equ	0x000C0000 - VARIABLE_VIDEO_MODE_BASE_ADDRESS
