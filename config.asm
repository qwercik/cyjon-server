...
%define	VARIABLE_KERNEL_VERSION			"0.643"
...
VARIABLE_MEMORY_PAGE_FLAG_SIZE_4KIB		equ	0x04
VARIABLE_MEMORY_PAGE_FLAG_ROOT			equ	0x08
...
VARIABLE_KERNEL_SERVICE_VFS_READ_FILE		equ	0x0500
VARIABLE_KERNEL_SERVICE_VFS_FILE_SIZE		equ	0x0501
VARIABLE_KERNEL_SERVICE_VFS_TOUCH		equ	0x0502
VARIABLE_KERNEL_SERVICE_VFS_ROOT_DIR		equ	0x0503
VARIABLE_KERNEL_SERVICE_VFS_SAVE_FILE		equ	0x0504
VARIABLE_KERNEL_SERVICE_VFS_DELETE		equ	0x0505

VARIABLE_KERNEL_SERVICE_VIDEO			equ	0x06
VARIABLE_KERNEL_SERVICE_VIDEO_SCREEN_CLEAR	equ	0x0600
VARIABLE_KERNEL_SERVICE_VIDEO_PIXEL_SET		equ	0x0601
