...
%define	VARIABLE_KERNEL_VERSION			"0.644"
...
VARIABLE_KERNEL_SERVICE_VFS_FILE_TOUCH		equ	0x0503
VARIABLE_KERNEL_SERVICE_VFS_FILE_GET_SIZE	equ	0x0504
VARIABLE_KERNEL_SERVICE_VFS_FILE_DELETE		equ	0x0505
