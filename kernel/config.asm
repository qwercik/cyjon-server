...
; KEYBOARD
;===============================================================================
KERNEL_KEYBOARD_SEQUENCE_0				equ	0xE0
KERNEL_KEYBOARD_SEQUENCE_1				equ	0xE1

KERNEL_KEYBOARD_PRESS_CTRL				equ	0x8000 + KEYBOARD_SCANCODE_CTRL
KERNEL_KEYBOARD_PRESS_SHIFT_LEFT			equ	0x8000 + KEYBOARD_SCANCODE_SHIFT_LEFT
KERNEL_KEYBOARD_PRESS_SHIFT_RIGHT			equ	0x8000 + KEYBOARD_SCANCODE_SHIFT_RIGHT
KERNEL_KEYBOARD_PRESS_ALT				equ	0x8000 + KEYBOARD_SCANCODE_ALT
KERNEL_KEYBOARD_PRESS_CAPSLOCK				equ 0x8000 + KEYBOARD_SCANCODE_CAPSLOCK

KERNEL_KEYBOARD_RELEASE_CTRL				equ	0x80 + KERNEL_KEYBOARD_PRESS_CTRL
KERNEL_KEYBOARD_RELEASE_SHIFT_LEFT			equ	0x80 + KERNEL_KEYBOARD_PRESS_SHIFT_LEFT
KERNEL_KEYBOARD_RELEASE_SHIFT_RIGHT			equ	0x80 + KERNEL_KEYBOARD_PRESS_SHIFT_RIGHT
KERNEL_KEYBOARD_RELEASE_ALT				equ	0x80 + KERNEL_KEYBOARD_PRESS_ALT
KERNEL_KEYBOARD_RELEASE_CAPSLOCK			equ 0x80 + KERNEL_KEYBOARD_PRESS_CAPSLOCK
...
KEYBOARD_SCANCODE_TAB					equ	0x0F
KEYBOARD_SCANCODE_CTRL					equ	0x1D
KEYBOARD_SCANCODE_SHIFT_LEFT				equ	0x2A
KEYBOARD_SCANCODE_SHIFT_RIGHT				equ	0x36
KEYBOARD_SCANCODE_ALT					equ	0x38
KEYBOARD_SCANCODE_CAPSLOCK					equ 0x3A
