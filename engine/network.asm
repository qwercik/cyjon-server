...
VARIABLE_NETWORK_FRAME_IP_SIZE_VER_HLEN			equ	0x01
VARIABLE_NETWORK_FRAME_IP_SIZE_SERVICE_TYPE		equ	0x01
VARIABLE_NETWORK_FRAME_IP_SIZE_TOTAL_LENGTH		equ	0x02
VARIABLE_NETWORK_FRAME_IP_SIZE_IDENTIFICATION		equ	0x02
VARIABLE_NETWORK_FRAME_IP_SIZE_FLAGS_FRAG_OFFSET	equ	0x02
VARIABLE_NETWORK_FRAME_IP_SIZE_TTL			equ	0x01
VARIABLE_NETWORK_FRAME_IP_SIZE_PROTOCOL			equ	0x01
VARIABLE_NETWORK_FRAME_IP_SIZE_CHECKSUM			equ	0x02
VARIABLE_NETWORK_FRAME_IP_SIZE_SENDER_IP		equ	0x04
VARIABLE_NETWORK_FRAME_IP_SIZE_TARGET_IP		equ	0x04
VARIABLE_NETWORK_FRAME_IP_SIZE				equ	VARIABLE_NETWORK_FRAME_IP_SIZE_VER_HLEN + VARIABLE_NETWORK_FRAME_IP_SIZE_SERVICE_TYPE + VARIABLE_NETWORK_FRAME_IP_SIZE_TOTAL_LENGTH + VARIABLE_NETWORK_FRAME_IP_SIZE_IDENTIFICATION + VARIABLE_NETWORK_FRAME_IP_SIZE_FLAGS_FRAG_OFFSET + VARIABLE_NETWORK_FRAME_IP_SIZE_TTL + VARIABLE_NETWORK_FRAME_IP_SIZE_PROTOCOL + VARIABLE_NETWORK_FRAME_IP_SIZE_CHECKSUM + VARIABLE_NETWORK_FRAME_IP_SIZE_SENDER_IP + VARIABLE_NETWORK_FRAME_IP_SIZE_TARGET_IP
VARIABLE_NETWORK_FRAME_IP_FIELD_VER_HLEN		equ	0x00
VARIABLE_NETWORK_FRAME_IP_FIELD_SERVICE_TYPE		equ	VARIABLE_NETWORK_FRAME_IP_FIELD_VER_HLEN + VARIABLE_NETWORK_FRAME_IP_SIZE_VER_HLEN
VARIABLE_NETWORK_FRAME_IP_FIELD_TOTAL_LENGTH		equ	VARIABLE_NETWORK_FRAME_IP_FIELD_SERVICE_TYPE + VARIABLE_NETWORK_FRAME_IP_SIZE_SERVICE_TYPE
...
VARIABLE_NETWORK_FRAME_IP_FIELD_FLAGS_FRAG_OFFSET	equ	VARIABLE_NETWORK_FRAME_IP_FIELD_IDENTIFICATION + VARIABLE_NETWORK_FRAME_IP_SIZE_IDENTIFICATION
VARIABLE_NETWORK_FRAME_IP_FIELD_TTL			equ	VARIABLE_NETWORK_FRAME_IP_FIELD_FLAGS_FRAG_OFFSET + VARIABLE_NETWORK_FRAME_IP_SIZE_FLAGS_FRAG_OFFSET
...
VARIABLE_NETWORK_FRAME_IP_FIELD_CHECKSUM		equ	VARIABLE_NETWORK_FRAME_IP_FIELD_PROTOCOL + VARIABLE_NETWORK_FRAME_IP_SIZE_PROTOCOL
VARIABLE_NETWORK_FRAME_IP_FIELD_SENDER_IP		equ	VARIABLE_NETWORK_FRAME_IP_FIELD_CHECKSUM + VARIABLE_NETWORK_FRAME_IP_SIZE_CHECKSUM
