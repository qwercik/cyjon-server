...
cyjon_network_i8254x_reset:
	...
	mov	eax,	VARIABLE_NIC_INTEL_82540EM_RCTL_EN | VARIABLE_NIC_INTEL_82540EM_RCTL_SBP | VARIABLE_NIC_INTEL_82540EM_RCTL_BAM | VARIABLE_NIC_INTEL_82540EM_RCTL_SECRC
