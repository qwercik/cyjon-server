...
stage2_paging:
	...
	; pml3[ 1 ]
	mov	eax,	VARIABLE_MEMORY_PAGING_ADDRESS + 0x3000 + 0x03	; bity Administrator, Zapis, Aktywna
	stosd	; zapisz do pml3[ 1 ]
	xor	eax,	eax	; starsza część adresu pml2
	stosd	; zapisz do pml3[ 1 ]

	; pml3[ 2 ]
	mov	eax,	VARIABLE_MEMORY_PAGING_ADDRESS + 0x4000 + 0x03	; bity Administrator, Zapis, Aktywna
	stosd	; zapisz do pml3[ 2 ]
	xor	eax,	eax	; starsza część adresu pml2
	stosd	; zapisz do pml3[ 2 ]

	; pml3[ 3 ]
	mov	eax,	VARIABLE_MEMORY_PAGING_ADDRESS + 0x5000 + 0x03	; bbity Administrator, Zapis, Aktywna
